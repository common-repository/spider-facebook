...
var keyCode = event.keyCode ? event.keyCode : event.which ? event.which : event.charCode;
    ...
    <?php echo "<h2 style=\"float:left\">".'WD Social Widgets'. "</h2>"; ?>
...
document.getElementById('request_hover').style.display='none';
			...
			document.getElementById('notification').innerHTML='A set of social widgets for LinkedIn, Twitter and Facebook.';
		break;
